...
class TextureLoader extends js.Object {
    def this(manager: LoadingManager = js.native) = this()
    var crossOrigin: String = js.native
    def load(url: String, onLoad: js.Function1[Texture, Unit], onProgress: js.Function1[XMLHttpRequest, Unit], onError: js.Function1[XMLHttpRequest, Unit]): Unit = js.native
    def setCrossOrigin(crossOrigin: String): Unit = js.native
}
...
class Line extends Object3D {
    def this(geometry: Geometry = js.native, material: Material = js.native, `type`: Double = js.native) = this()
